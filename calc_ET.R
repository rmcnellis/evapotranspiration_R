...
calc_ET <- function(y = 0.06, Pa, Ta, RH, J, l, elev, ns, as = 0.25, bs = 0.5, alb, 
                    Tmax, Tmin, L, h, ux, x = 2, gl, Sc = 1, Pr = 1, SM, SMs = 0.5, 
                    n = 2, zs = 0.004, Cp = 1005) {
  ...
  # net radiation for location and day
  ...
  # resistance coefficients, Eq. 13-17
  rA <- (s + y) * ra 
  rS <- (s + y) * rg + (y * rs)
  rC <- (s + y) * rv + (y * rc)
...
calc_ETs <- function(y = 0.06, Pa, Ta, RH, J, l, elev, ns, as = 0.25, bs = 0.5, alb, 
                     Tmax, Tmin, ux, x = 2, Sc = 1, Pr = 1, SM, SMs = 0.5, 
                     n = 2, zs = 0.004, Cp = 1005) {
